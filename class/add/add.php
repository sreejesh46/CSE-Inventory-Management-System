<?php
	...
	class add {
		...
		public function add_equipment($e_number,$e_model,$e_category,$e_brand,$e_description,$e_stock,$e_assigned,$e_type,$e_status)
		{
			global $conn;
		...
		public function add_newfaculty($f_id,$f_fname,$f_lname,$f_gender,$f_contact,$f_department,$type,$h_desc,$h_tbl,$sessionid,$sessiontype)
		{
			global $conn;
	...
	switch ($key){
		...
		$f_department = trim($_POST['f_department']);
 		$type = 'Faculty';
		$add_function->add_newfaculty($f_id,$f_fname,$f_lname,$f_gender,$f_contact,$f_department,$type,$h_desc,$h_tbl,$sessionid,$sessiontype);
		break;
